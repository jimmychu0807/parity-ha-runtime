...
// note: commented the following to quiet down the warning
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("chain01"),
	impl_name: create_runtime_str!("chain01"),
	authoring_version: 3,
	spec_version: 4,
	impl_version: 4,
...
impl cat_auction::Trait for Runtime {
	type Event = Event;
}
